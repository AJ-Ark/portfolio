...
"[project]/src/components/ui/DimensionCallout.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function DimensionCallout(param) {
    let { value, label, accent = "#FFA426", animate = true } = param;
    _s();
    const ref = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [visible, setVisible] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(!animate);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DimensionCallout.useEffect": ()=>{
            if (!animate) return;
            const observer = new IntersectionObserver({
                "DimensionCallout.useEffect": (param)=>{
                    let [entry] = param;
            ...
            return ({
                "DimensionCallout.useEffect": ()=>observer.disconnect()
            })["DimensionCallout.useEffect"];
        }
    }["DimensionCallout.useEffect"], [
        animate
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        fileName: "[project]/src/components/ui/DimensionCallout.tsx",
                        lineNumber: 43,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(DimensionCallout, "u4MsbzlXmOmdz9dLAhQm1HArP18=");
_c = DimensionCallout;
var _c;
__turbopack_context__.k.register(_c, "DimensionCallout");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
// ─── Behaviour: Rippl — concentric rings emanating from points ───
function getRipplPositions(count, time) {
    const pos = new Float32Array(count * 3);
    const rings = 12;
    for(let i = 0; i < count; i++){
        const ring = Math.floor(i / (count / rings));
        const angle = i / (count / rings) * Math.PI * 2;
        const radius = (ring + 1) * 0.8 + Math.sin(time * 0.5 + ring * 0.4) * 0.3;
...
// ─── Behaviour: Realm — organic swarm / butterfly silhouette ───
function getRealmPositions(count, time) {
    const pos = new Float32Array(count * 3);
    for(let i = 0; i < count; i++){
        const t = i / count;
        // Butterfly wing parametric (simplified)
        const angle = t * Math.PI * 4;
        const r = Math.pow(Math.abs(Math.cos(angle * 2)), 0.5) * 3 + Math.sin(time * 0.3 + i * 0.001) * 0.5;
        const drift = Math.sin(time * 0.2 + i * 0.002) * 0.8;
        pos[i * 3] = Math.cos(angle) * r + drift;
        pos[i * 3 + 1] = Math.sin(angle) * r * 0.6 + Math.sin(time * 0.4 + i * 0.003) * 0.3;
        pos[i * 3 + 2] = Math.sin(i * 0.1) * 2 + drift * 0.5;
    }
    return pos;
}
// ─── Behaviour: Trmeric — structured data lattice ───
function getTrmericPositions(count, time) {
    const pos = new Float32Array(count * 3);
    ...
    for(let i = 0; i < count; i++){
        ...
        const flow = Math.sin(time * 0.6 + x * 0.5 + y * 0.3) * 0.15;
        pos[i * 3] = x * 0.6 + flow;
        pos[i * 3 + 1] = y * 0.6 + flow;
        pos[i * 3 + 2] = z * 0.6;
    }
    return pos;
}
function getIdlePositions(count, time) {
    const pos = new Float32Array(count * 3);
    for(let i = 0; i < count; i++){
        const theta = i / count * Math.PI * 2;
        const phi = Math.acos(2 * (i / count) - 1);
        const r = 4 + Math.sin(time * 0.2 + i * 0.01) * 0.5;
...
function getDomainColor(domain) {
    if (domain === "rippl") return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"]("#78B9C5");
    if (domain === "realm") return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"]("#4A9E8E");
    if (domain === "trmeric") return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"]("#FFA426");
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"]("#6B6157");
}
function ParticleField(param) {
    let { domain = null, morphProgress = 1 } = param;
    _s();
    ...
    const geometry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const prevDomainRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$b389eeca$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"])({
        "ParticleField.useFrame": (state, delta)=>{
            ...
            const targetPos = domain === "rippl" ? getRipplPositions(PARTICLE_COUNT, t) : domain === "realm" ? getRealmPositions(PARTICLE_COUNT, t) : domain === "trmeric" ? getTrmericPositions(PARTICLE_COUNT, t) : getIdlePositions(PARTICLE_COUNT, t);
            const currentAttr = geometry.current.attributes.position;
            const current = currentAttr.array;
            // Smooth lerp toward target
            const lerpSpeed = 0.03;
            for(let i = 0; i < PARTICLE_COUNT * 3; i++){
                current[i] += (targetPos[i] - current[i]) * lerpSpeed;
            }
            ...
            if (mat) {
                const target = getDomainColor(domain);
                mat.color.lerp(target, 0.02);
                mat.opacity = 0.6 + Math.sin(t * 0.5) * 0.1;
            }
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("points", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("pointsMaterial", {
                size: size.width < 768 ? 0.018 : 0.012,
...
_s(ParticleField, "xxwJKjy14ccauSTD0M8ccdrSQ6M=", false, function() {
    return [
...
"[project]/src/components/3d/Scene.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$react$2d$three$2d$fiber$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Canvas"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$3d$2f$ParticleField$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                fileName: "[project]/src/components/3d/Scene.tsx",
                lineNumber: 28,
                columnNumber: 9
            }, this)
        }, void 0, false, {
...
//# sourceMappingURL=src_components_8571babc._.js.map