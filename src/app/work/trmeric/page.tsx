...
const FEATURES: Feature[] = [
  {
    ...
    theoryRef: "Nielsen (1994) · Conversational UI design",
  ...
  },
  {
    ...
    stat: { value: "23", label: "iterations · v13 → v36" },
    ...
    imgRatio: "16/10",
    body: "The Portfolio Monitor went through 23 iterations (v13 to v36). Every version that added more features was rejected. The v36 that shipped had fewer visible controls than v13, but each control carried more context. The breakthrough came from a single directive from Siddharth: 'less is more.' Not less data. Less interface. The challenge was showing the full portfolio across all lifecycle phases to three completely different personas (Portfolio Leader, CIO, Resource Manager) using one unified surface that adapts rather than fragmenting into separate dashboards.",
    decisions: [
    ...
    theoryRef: "Miller (1956) · Information scent theory · Force-directed graph",
  ...
  },
  {
    ...
    theory: "Nonaka & Takeuchi knowledge spiral (1995): tacit-to-explicit knowledge conversion. Trucible makes organizational tacit knowledge (what people know but haven't written) explicit and searchable via Tango. Information architecture: card-based progressive disclosure. The dual mode splits reading-to-understand from browsing-to-find.",
    theoryRef: "Nonaka & Takeuchi (1995) · Search vs browse · PKM theory",
  ...
  },
  {
    ...
    stat: { value: "79", label: "signals on one living map" },
